...
import reto3.reto4.servicios.ServicesReservation;
...
public class ReservationWeb {
    ...
    {
        return servicio.getReporteStatus();
    }
    ...
    {
        return servicio.getReportesTiempos(dateOne, dateTwo);
    }
    
    @GetMapping("/report-clients")
    public List<CountClient> getCliente()
    {
